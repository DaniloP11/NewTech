...
$sql = $con->prepare("SELECT id, nombre, precio FROM consolas WHERE activo=1");
$sql->execute();
                  ...
                  <?php foreach($resultado as $row){ ?>
                    <div class="col">
                      <div class="card shadow-sm">
                          ...
                          $id = $row["id"];
                          $imagen = "images/consolas/" . $id . "/productos.jpg";
                        ...
                        <div class="card-body">
                          ...
                          <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                              <a href="detailsconsol.php?id=<?php echo $row['id']; ?>&token=<?php echo 
